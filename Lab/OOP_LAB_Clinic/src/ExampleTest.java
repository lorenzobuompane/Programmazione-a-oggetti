...
//		ADD
//		hospital.addDoctor("L", "Sun","a", 1,"Physician");
//		hospital.addDoctor("M", "Sun","b", 2,"z");
//		hospital.addDoctor("N", "Sun","c", 3,"z");
//		hospital.addDoctor("O", "Sun","d", 4,"m");
//		hospital.assignPatientToDoctor("SSNMDS", 4);
//		hospital.assignPatientToDoctor("ALCGRN", 2);
		
		hospital.countPatientsPerSpecialization();	
	}
