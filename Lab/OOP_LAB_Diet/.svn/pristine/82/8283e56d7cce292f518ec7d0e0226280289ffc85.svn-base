...
public class Food {
	...
	private TreeMap<String, NutritionalElement> rw;
	private TreeMap<String, NutritionalElement> p;
	private TreeMap<String, NutritionalElement> r;
 ...
 * The nutritional values are specified for a conventional 100g quantity
	...
	public void defineRawMaterial(String name, double calories, double proteins, double carbs, double fat){
		rw.put(name, new RawMaterial(name, calories, proteins, carbs, fat));
	}
	...
	public void defineProduct(String name, double calories, double proteins, double carbs, double fat){
		p.put(name, new Product(name, calories, proteins, carbs, fat));
	}
	...
	public Recipe createRecipe(String name) {
		Recipe re = new Recipe (name, this);
		r.put(name, re);
		return re;
	}
